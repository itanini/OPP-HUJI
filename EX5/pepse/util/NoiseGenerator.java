...
/**
 * This is an implementation of the Perlin noise algorithm we use for generating pseudo random terrain.
 * The Code was written by alksily (GitHub username), and the link to the full implementation is:
